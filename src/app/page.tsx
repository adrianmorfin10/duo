  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 flex justify-between items-center">
        {/* Logo - Versión para fondo negro */}
        <div className="relative w-40 h-12"> {/* Ajusta el tamaño según tu logo */}
          <Image
            src="/duoblack.svg" // Usamos la versión blanca para fondo negro
            alt="DuoTalent"
            fill
...
>
  {/* Fondo dinámico con formas animadas */}
  <div className="absolute inset-0 z-0 overflow-hidden">
    {/* Forma 1 - Círculo grande que cruza horizontalmente */}
    <motion.div
      animate={{
        x: ["-100%", "150%"],
        rotate: [0, 360],
    ...
    {/* Forma 3 - Círculo pequeño en zigzag */}
    <motion.div
      animate={{
        x: ["0%", "90%", "10%", "100%", "0%"],
        y: ["0%", "80%", "20%", "60%", "0%"],
...
{/* Sección de Clientes con Animaciones */}
<section id="clients" className="py-16 bg-gray-50 overflow-hidden">
  <div className="container mx-auto px-6">
    ...
    {/* Versión 1: Efecto de flotación infinita (recomendado) */}
...
>
  <div className="container mx-auto px-6">
    ...
    {/* Cards mejoradas - Sin espacio excesivo */}
    <motion.div 
      variants={staggerContainer}
      className="grid md:grid-cols-3 gap-6" // Reduje el gap a 6
    >
      {[
        { 
    ...
    <motion.div
      ...
      viewport={{ once: true }}
      className="text-center mt-10" // Reduje el margen superior
    >
        ...
        >
          ...
          <div className="relative h-64 overflow-hidden">
            <Image
              ...
              quality={90}
            />
            {/* Gradiente horizontal negro */}
            <div className="absolute inset-0 bg-gradient-to-r from-black/70 via-black/40 to-transparent"></div>
            {/* Refuerzo de gradiente vertical en la parte inferior */}
